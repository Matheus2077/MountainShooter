...
class Level:
    ...
    def run(self):
        ...
        while True:
            ...
            # CORREÇÃO AQUI: Adicionado 'text_color=' antes de COLOR_WHITE
    ...
    def level_text(self, text_size: int, text: str, text_color: tuple, text_pos: tuple):
        ...
        # CORREÇÃO AQUI: No .render(), ou você tira o 'antialias=' ou coloca 'color=' no text_color
        text_surf: Surface = text_font.render(text, True, text_color).convert_alpha()

        text_rect: Rect = text_surf.get_rect(left=text_pos[0], top=text_pos[1])
        self.window.blit(source=text_surf, dest=text_rect)

      #  import sys CÓDIGO DO PROF.
    ...
    #
    #             # printed text
    #             self.level_text(text_size=14, text=f'{self.name} - Timeout: {self.timeout / 1000 :.1f}s', COLOR_WHITE,text_pos=(10, 5))
